    ...
    >
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-b border-[rgba(207,175,126,0.2)] select-none">
            <h2 className="font-playfair text-lg font-medium select-none">Menu</h2>
            <button
              onClick={handleClose}
